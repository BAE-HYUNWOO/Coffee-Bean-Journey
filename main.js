...
const HERO_SLIDE_CANDIDATES = [
  ...
  "coffee-5.png",
  "coffee-5.webp",
].map((fileName) => `./public/images/hero-slides/${fileName}`);
...
function renderHome() {
  ...
  featureText.append("p")
    .text("From tropical farms to urban caf챕s, coffee connects global production, cross-border trade, brand power, everyday consumption and climate uncertainty.");
  ...
  footer.append("p").attr("class", "footer-note").text("짤 Coffee Journey Data Visualization Project");
